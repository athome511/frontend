          ...
          if(!headerState) {
            ...
            return (
              ...
              <ul className="headerList">
                ...
                <li><Link to={`/myPage/accountStatus`}><p><img src={headerState.u_icon} alt={`User Icon : ${headerState.u_name}`} />マイページ</p></Link>
                  <ul>
                    <li><Link to={`/myPage/accountChange`}><p>アカウント変更</p></Link></li>
                    <li><Link to={`/myPage/closet`}><p>服一覧</p></Link></li>
                    <li><a href="../static/news.html" target="_blank"><p>お知らせ</p></a></li>
